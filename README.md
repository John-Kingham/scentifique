...
This is the final plane, where we add colour and other details to our bare wireframes.

### Colour Palette

The colours below were inspired by the arts & crafts wallpapers of William Morris, 
examples of which are available at sites like [Wall passion](https://www.wallpassion.co.uk/william-morris).
...
The fields use generic types such as `number` or `string`, as the exact types
and fields were to be decided during the iterative development phase.

### Implemented Database Schema

[NOTE CHANGES BETWEEN ERD AND FINAL SCHEMA]
